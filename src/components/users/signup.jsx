        ...
        <div 
            ...
            <div class="flex h-full flex-col justify-center gap-4 p-6">
                <div class="left-0 right-0 inline-block border-gray-200 px-2 py-2.5 sm:px-4">
                    <form class="flex flex-col gap-4 pb-4" action="http://localhost:4000/api/signup" method="post">
                        <h1 class="mb-4 text-2xl font-bold  dark:text-white">Signup</h1>
                        <div>
                            <div class="mb-2">
                            ...
                            <div class="flex w-full rounded-lg pt-1">
                                <div class="relative w-full"><input
                                        ...
                                        id="fullName" type="text" name="fullName" placeholder="jhon doe"
                                        required=""/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="min-w-[270px]">
                        <div class="mt-4 text-center dark:text-gray-200">already have an account?
                            <a class="text-blue-500 underline hover:text-blue-600" href="/login">login</a>
                        </div>
                    </div>
                </div>
            </div>
